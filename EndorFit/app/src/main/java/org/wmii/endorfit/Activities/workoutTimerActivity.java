...
import org.wmii.endorfit.Adapters.AdapterWorkout;
...
import org.wmii.endorfit.Adapters.timerDialog;

import java.util.ArrayList;
import java.util.Date;

public class workoutTimerActivity extends AppCompatActivity implements timerDialog.timerDialogListener {
        ...
        planContentRef.setValue(dbSave).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(workoutTimerActivity.this, "Saved your progress", Toast.LENGTH_SHORT).show();
                    planItems.clear();
                } else {
                    Toast.makeText(workoutTimerActivity.this, "Something went wrong", Toast.LENGTH_SHORT).show();
